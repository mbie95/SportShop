...
public class BasketController {
    ...
    private BasketItem convertToBasketItemEntity(BasketItemResponse itemResponse) {
        ...
        basketItem.setBrand(itemResponse.getBrand());
        basketItem.setType(itemResponse.getType());
